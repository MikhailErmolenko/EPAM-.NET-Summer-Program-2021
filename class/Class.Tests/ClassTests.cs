...
namespace Class.Tests
{
    ...
    public class ClassTests
    {
        ...
        private object GetRectangleInstance(params object[] args)
        {
        ...
        private Type GetArrayRectanglesType()
        {
        ...
        private object GetArrayRectanglesInstance(params object[] args)
        {
        ...
        [TestCase("ArrayRectangles", typeof(int))]
        public void Class_HasPublicConstructor(string className, params Type[] parameters)
        {
            var type = Type.GetType($"Class.{className}" + ", Class");
        ...
        {
            var arrayRectanglesType = Type.GetType("Class.ArrayRectangles, Class");
            var rectangleType = Type.GetType("Class.Rectangle, Class");

            if (arrayRectanglesType == null)
            {
                Assert.Fail($"Class 'ArrayRectangles' doesn't exist.");
            }
            ...
            if ((enumerableConstructor == null && !enumerableConstructor.IsPublic)
                || (arrayConstructor == null && !arrayConstructor.IsPublic))
                Assert.Fail($"Class 'ArrayRectangles' doesn't have public constructor that takes IEnumerable or array.");
        }

        [TestCase("Rectangle", "sideA")]
        [TestCase("Rectangle", "sideB")]
        [TestCase("ArrayRectangles", "rectangle_array")]
        public void Class_HasPrivateField(string className, string fieldName)
        {
            var type = Type.GetType($"Class.{className}" + ", Class");
        ...
        public void Class_HasPublicMethodWithCorrectSignature(string className, string methodName, Type returnType,
        ...
        public void Rectangle_GetSideAWithConstructorThatTakes2Parameters_ReturnsCorrectValue(double sideA, double sideB)
        {
        ...
        [TestCase(2.28, 1234)]
        [TestCase(13.37, 14.89)]
        public void Rectangle_GetSideBWithConstructorThatTakes2Parameters_ReturnsCorrectValue(double sideA, double sideB)
        {
        ...
        [TestCase(2.28, 5)]
        [TestCase(13.37, 5)]
        public void Rectangle_GetSideAWithConstructorThatTakes1Parameter_ReturnsCorrectValue(double sideA, double sideB)
        {
            var expectedSideA = sideA;
            var expectedSideB = sideB;
        ...
        [TestCase(2.28, 5)]
        [TestCase(13.37, 5)]
        public void Rectangle_GetSideBWithConstructorThatTakes1Parameter_ReturnsCorrectValue(double sideA, double sideB)
        {
            var expectedSideA = sideA;
            var expectedSideB = sideB;
        ...
        [TestCase(4, 3)]
        public void Rectangle_GetSideAWithConstructorThatTakes0Parameters_ReturnsCorrectValue(double sideA, double sideB)
        {
            var expectedSideA = sideA;
            var expectedSideB = sideB;
            ...
            if (expectedSideA != (double)GetSideA.Invoke(rectangle, null) && expectedSideB == sideB)
            {
        ...
        [TestCase(4, 3)]
        public void Rectangle_GetSideBWithConstructorThatTakes0Parameters_ReturnsCorrectValue(double sideA, double sideB)
        {
            var expectedSideA = sideA;
            var expectedSideB = sideB;
            ...
            if (expectedSideB != (double)GetSideB.Invoke(rectangle, null) && expectedSideA == sideA)
            {
        ...
        public void Rectangle_Area_ReturnsCorrectValue(double sideA, double sideB, double result)
        {
            var type = Type.GetType("Class.Rectangle" + ", Class");
        ...
        [TestCase(1, 2)]
        [TestCase(1, 1)]
        public void Rectangle_Perimeter_ReturnsCorrectValue(double sideA, double sideB)
        {
            var type = Type.GetType("Class.Rectangle" + ", Class");
        ...
        public void Rectangle_IsSquare_ReturnsCorrectValue(double sideA, double sideB, bool result)
        {
            var type = Type.GetType("Class.Rectangle" + ", Class");
        ...
        [TestCase(1, 2)]
        [TestCase(2, 3)]
        public void Rectangle_ReplaceSides_SwitchSides(double sideA, double sideB)
        {
            var type = Type.GetType("Class.Rectangle" + ", Class");
        ...
        [TestCase(4)]
        [TestCase(10)]
        public void ArrayRectangles_ConstructorThatTakesInt_AssignsCorrectValueToField(int length)
        {
        ...
        [Test]
        public void ArrayRectangles_ConstructorThatTakesEnumerableOrArray_AssignsCorrectValueToField()
        {
        ...
        [TestCase(7)]
        [TestCase(0)]
        public void ArrayRectangles_AddRectangle_AddsRectangleOnFirstFreePlace(int addCount)
        {
            //arrange
            var arrRectType = GetArrayRectanglesType();
            var rectangleType = GetRectangleType();
        ...
        [Test]
        public void ArrayRectangles_AddRectangle_ReturnsTrueIfArrayHasFreePlace()
        {
            //arrange
            var arrRectType = GetArrayRectanglesType();
        ...
        [Test]
        public void ArrayRectangles_AddRectangle_ReturnsFalseIfArrayHasNotFreePlace()
        {
            //arrange
            var arrRectType = GetArrayRectanglesType();
        ...
        [Test]
        public void ArrayRectangles_NumberMaxArea_ReturnsCorrectValue()
        {
            //arrange
            var arrRectType = GetArrayRectanglesType();
        ...
        [Test]
        public void ArrayRectangles_NumberMinPerimeter_ReturnsCorrectValue()
        {
            //arrange
            var arrRectType = GetArrayRectanglesType();
        ...
        [Test]
        public void ArrayRectangles_NumberSquare_ReturnsCorrectValue()
        {
            //arrange
            var arrRectType = GetArrayRectanglesType();
